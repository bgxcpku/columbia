...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\State Find the node \M \space in the tree sharing the longest suffix with \Seq \space and update indices on edges in the path from \M \space to the root
