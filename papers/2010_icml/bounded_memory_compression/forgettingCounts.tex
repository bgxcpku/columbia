...
\twocolumn[
\icmltitle{Forgetting Counts : Constant Memory Inference \\
for a Dependent Hierarchical Pitman-Yor Process}
...
\icmlauthor{David Pfau}{pfau@neurotheory.columbia.edu}
\icmlauthor{Frank Wood}{fwood@stat.columbia.edu}
\icmladdress{Columbia University, Department of Statistics, New York, NY, USA}
...
\input{forgettingCounts_abstract}

\input{forgettingCounts_introduction}

\input {forgettingCounts_theBasicModel}

\input{forgettingCounts_theory}

\input{forgettingCounts_inference}

\input{forgettingCounts_results}

\input{forgettingCounts_discussion}
