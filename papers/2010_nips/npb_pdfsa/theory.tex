...
\begin{figure}[htbp]
\begin{center}
\subfigure{\includegraphics[scale=0.8]{even.pdf}} \\
\subfigure{\includegraphics[scale=0.6]{reber.pdf}} \\
\subfigure{\includegraphics[scale=0.6]{feldman.pdf}}
\label{fig:synthetic_grammar}
\caption{Synthetic grammars used in Figure \ref{fig:synth_results}.  Top to bottom: the even process, the Reber grammar, the Feldman grammar.}
\end{center}
\end{figure}