...
\author[Bartlett]
{
  Nicholas~Bartlett, David~Pfau, Frank~Wood %\inst{1}
}
...
\begin{frame}[t]{A Tangible Goal}
	Define a stochastic process which approximates the inferential power of the sequence memoizer model, requires fewer nodes to be represented, and permits tractable inference.\\
	\vspace{1cm}
	\begin{center}
		Easily stated, but how?
	\end{center}
\end{frame}
