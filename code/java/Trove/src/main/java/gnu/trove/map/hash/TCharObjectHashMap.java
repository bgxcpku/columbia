...
public class TCharObjectHashMap<V> extends TCharHash implements
     ...
     */
    public TCharObjectHashMap( TCharObjectMap<V> map ) {
    ...
    @SuppressWarnings({"unchecked"})
    private V doPut( char key, V value, int index ) {
        byte previousState;
        V previous = null;
   ...
   public char[] keys( char[] dest ) {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings({"unchecked"})
    public boolean forEachEntry( TCharObjectProcedure<V> procedure ) {
        byte[] states = _states;
        char[] keys = _set;
        V[] values = _values;
    ...
    /** {@inheritDoc} */
    @SuppressWarnings({"unchecked"})
    public boolean retainEntries( TCharObjectProcedure<V> procedure ) {
