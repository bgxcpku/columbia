...
public class ConstantSpaceRestaurant extends ByteMap<ConstantSpaceRestaurant>{
    ...
    public ConstantSpaceRestaurant(ConstantSpaceRestaurant parent, int edgeStart, int edgeLength){
        this.parent = parent;
    ...
    public ConstantSpaceRestaurant fragmentForInsertion(ConstantSpaceRestaurant irParent, int irEdgeStart, int irEdgeLength, double discount, double irDiscount){
        ...
        intermediateRestaurant = new ConstantSpaceRestaurant(irParent, irEdgeStart, irEdgeLength);
        if(types == null){
