...
void GibbsSamplerLDACOL( double ALPHA, double BETA, double GAMMA0, double GAMMA1, double DELTA, int W, int T, int D, int NN, int OUTPUT, int n, int *z, int *d, int *w, int *s, int *c, int *sc, int *wp, int *dp, int *ztot, int *wtot, int *order, double *probs, double *srww, int *irww, int *jcww, int *wc, int startcond )
{
                 ...
                 const mxArray *prhs[])
{
  ...
  int *irww, *jcww, *irwp, *jcwp, *irdp, *jcdp;
